...
def update_metastatic_site(drug_list):
    ...
    if drug_list:
	    for drug in drug_list:
	    	traces.append(go.Scatter(x = metastatic_grouped[metastatic_grouped['Drug Regimen']==drug].index,
		    	y = metastatic_grouped[metastatic_grouped['Drug Regimen'] == drug]['Metastatic Sites'],
		    							opacity=0.6,
		    							name = drug,
		    							marker = dict(color=drug_colors[drug])
